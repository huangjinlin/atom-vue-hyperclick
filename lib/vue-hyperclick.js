...
function makeProvider(ctx) {
    const jsHyperclick = require('../../atom-js-hyperclick')
...
module.exports = {
    ...
    getProvider() {
        if(atom.packages.isPackageLoaded('atom-js-hyperclick')) {
            return makeProvider(this)
        }
        else {
            atom.notifications.addError('atom-vue-hyperclick: This package requires js-hyperclick to function.');
            return null;
        }
    },
    deactivate() {
